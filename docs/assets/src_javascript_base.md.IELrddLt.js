import{_ as s,c as n,a0 as p,o as l}from"./chunks/framework.xOXxqCsI.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/base.md","filePath":"src/javascript/base.md","lastUpdated":1727592456000}'),e={name:"src/javascript/base.md"};function i(t,a,c,o,r,d){return l(),n("div",null,a[0]||(a[0]=[p(`<h2 id="javascript的语法和数据类型" tabindex="-1">Javascript的语法和数据类型 <a class="header-anchor" href="#javascript的语法和数据类型" aria-label="Permalink to &quot;Javascript的语法和数据类型&quot;">​</a></h2><h3 id="_1-注释" tabindex="-1">1.注释 <a class="header-anchor" href="#_1-注释" aria-label="Permalink to &quot;1.注释&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//单行注释</span></span>
