import{_ as s,c as n,a0 as e,o as p}from"./chunks/framework.xOXxqCsI.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/ES6-2.md","filePath":"src/javascript/ES6-2.md","lastUpdated":1727592456000}'),i={name:"src/javascript/ES6-2.md"};function l(t,a,r,c,o,u){return p(),n("div",null,a[0]||(a[0]=[e(`<h3 id="_5函数扩展" tabindex="-1">5函数扩展 <a class="header-anchor" href="#_5函数扩展" aria-label="Permalink to &quot;5函数扩展&quot;">​</a></h3><h3 id="_5-1number-isfinite-number-isnan-比较" tabindex="-1">5.1Number.isFinite() Number.isNaN()比较 <a class="header-anchor" href="#_5-1number-isfinite-number-isnan-比较" aria-label="Permalink to &quot;5.1Number.isFinite() Number.isNaN()比较&quot;">​</a></h3><p>Number.isFinite() 用于检查一个数值是否是有限的，即不是 Infinity，若参数不是 Number类型，则一律返回 false 。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//检测是否是有限(正常数)</span></span>
