import{_ as n,c as a,a0 as p,o as e}from"./chunks/framework.CroFxgLA.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/oop.md","filePath":"src/javascript/oop.md","lastUpdated":1727592456000}'),l={name:"src/javascript/oop.md"};function t(i,s,c,o,r,d){return e(),a("div",null,s[0]||(s[0]=[p(`<h2 id="_1-1-工厂模式" tabindex="-1">1.1.工厂模式 <a class="header-anchor" href="#_1-1-工厂模式" aria-label="Permalink to &quot;1.1.工厂模式&quot;">​</a></h2><blockquote><p>工厂模式:每次返回的都是一个对象。优点：只需要传参数，不管其如何实现的。缺点：想添加类型时，必须修改原产品模型。</p></blockquote><ul><li>理解原型 Object 和Function都是js自带函数，Object继承自己，Function继承自己，相互继承对方，即Object和Function即是函数也是对象</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Function instanceof Object //true</span></span>
