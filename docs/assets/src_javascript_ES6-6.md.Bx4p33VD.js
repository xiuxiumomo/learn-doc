import{_ as a,c as n,a0 as p,o as e}from"./chunks/framework.CroFxgLA.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/ES6-6.md","filePath":"src/javascript/ES6-6.md","lastUpdated":1727592456000}'),l={name:"src/javascript/ES6-6.md"};function i(t,s,c,o,r,d){return e(),n("div",null,s[0]||(s[0]=[p(`<h2 id="_14-genrator-函数和应用" tabindex="-1">14.Genrator 函数和应用 <a class="header-anchor" href="#_14-genrator-函数和应用" aria-label="Permalink to &quot;14.Genrator 函数和应用&quot;">​</a></h2><blockquote><p>执行 Genrator 函数会返回一个遍历器对象，依次遍历 Genrator 内函数的每一个状态。特征： 1.function 关键字与函数名之间有个星号。2.函数体内使用 yield 表达式，定义不同状态。通过调用 next 方法将指针移向下一个状态，直到遇到下一个 yield 表达式(或 return)简单理解,Generator 函数分段执行，yield 表达式是暂时执行的标记而 next 执行回复。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function * f() {</span></span>
