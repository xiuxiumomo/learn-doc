import{_ as s,c as n,a0 as e,o as p}from"./chunks/framework.xOXxqCsI.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/ES6-4.md","filePath":"src/javascript/ES6-4.md","lastUpdated":1727592456000}'),t={name:"src/javascript/ES6-4.md"};function l(i,a,c,o,r,d){return p(),n("div",null,a[0]||(a[0]=[e(`<h2 id="_10-set和map数据结构" tabindex="-1">10.Set和Map数据结构 <a class="header-anchor" href="#_10-set和map数据结构" aria-label="Permalink to &quot;10.Set和Map数据结构&quot;">​</a></h2><blockquote><p>set数据结构和数组类似，但所有成员的值唯一</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let a = new Set();</span></span>
