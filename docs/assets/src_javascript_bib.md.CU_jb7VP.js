import{_ as s,c as a,a0 as p,o as l}from"./chunks/framework.xOXxqCsI.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/bib.md","filePath":"src/javascript/bib.md","lastUpdated":null}'),e={name:"src/javascript/bib.md"};function i(t,n,c,o,r,u){return l(),a("div",null,n[0]||(n[0]=[p(`<h2 id="_1-闭包" tabindex="-1">1.闭包 <a class="header-anchor" href="#_1-闭包" aria-label="Permalink to &quot;1.闭包&quot;">​</a></h2><blockquote><p>1.1 闭包: 有权访问另一个函数作用域中的变量函数，本质还是函数。闭包的特性</p></blockquote><ul><li><p>在一个函数内部定义</p></li><li><p>函数内部可以引用函数外部的变量。</p></li><li><p>参数和变量不会被回收。</p></li><li><p>将一个变量长期保存在内存中。(变量不销毁)</p></li><li><p>避免全局污染。</p></li><li><p>私有化成员，外部不可以访问</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function Fun() {</span></span>
