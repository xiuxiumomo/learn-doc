import{_ as s,c as n,a0 as e,o as p}from"./chunks/framework.CroFxgLA.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/javascript/object.md","filePath":"src/javascript/object.md","lastUpdated":1727592456000}'),l={name:"src/javascript/object.md"};function t(i,a,c,o,r,b){return p(),n("div",null,a[0]||(a[0]=[e(`<h2 id="javascript中关于对象的使用" tabindex="-1">javascript中关于对象的使用 <a class="header-anchor" href="#javascript中关于对象的使用" aria-label="Permalink to &quot;javascript中关于对象的使用&quot;">​</a></h2><blockquote><p>JavaScript的对象是一些列属性的集合，一个属性包含一个键值对(名称区分大小写A和a是不同属性)。</p></blockquote><h2 id="_1-创建对象的方法" tabindex="-1">1.创建对象的方法 <a class="header-anchor" href="#_1-创建对象的方法" aria-label="Permalink to &quot;1.创建对象的方法&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let obj = new Object();</span></span>
